...
const Vidhya = () => {
  return (
    <div class="v1">
      <h1>SRI VIDYARANYA AVASA VIDYALAYAM</h1>
      <p>Vidya Bharati Akhil Bhartiya Shiksha Sansthan, 
