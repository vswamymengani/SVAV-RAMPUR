  ...
  return (
    <div>
      <div className="Transport-container">
        <div className="Transport-content">
          ...
          <div id="Transportcontents">
            <h3><FaLightbulb /> Availability of Seats:</h3>
            <h3><FaPeopleArrows /> Bus Routes:</h3>
            <h3><FaChalkboardTeacher /> Pick Up & Drop Off:</h3>
            <h3><FaChild /> IDENTITY CARDS:</h3>
            <h3><FaHome /> Oneway Transport:</h3>
            <h3><FaChair /> Change of Address:</h3>
            <h3><FaLightbulb />  Discipline:</h3>
            <h3><FaPeopleArrows /> Transport Fee:</h3>
            <h3><FaChalkboardTeacher /> Mode of Payment:</h3>
            <h3><FaChild /> Refund:</h3>
          </div>
        </div>
      ...
      <div className="Transportpara">
        <span >
          <b><center>Transport Terms & Policies</center> </b> <br></br><br></br><br></br><br></br>
          ...
          .Parentsshould not board the bus & enter into argument with other staff or children to sort out any issue.
          <br></br><br></br>
          .No student/parentshall encourage the driver or the staff connected with the transport system to indulge in unfair practices such as giving tips to bus drivers for seeking favours. The transport services may be withdrawn if any such instances are found.
          <br></br><br></br><br></br><br></br>
          <b>9. Transport Fee:</b
          ><br></br><br></br>
