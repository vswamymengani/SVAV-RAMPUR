...
const UpdateFacultyForm = (props) => {
  ...
  useEffect(() => {
    const fetchFacultyData = async () => {
      if (facultyadmid) {
        try {
          const response = await axios.get(`http://www.svavrampur.com/api/faculty/${facultyadmid}`);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.put(`http://www.svavrampur.com/api/faculty/${facultyadmid}`, data);
