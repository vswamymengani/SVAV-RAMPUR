...
const UpdateFacultyForm = (props) => {
  ...
  useEffect(() => {
    const fetchFacultyData = async () => {
      if (facultyadmid) {
        try {
          const response = await axios.get(`https://www.svavrampur.com/api/faculty/${facultyadmid}`);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.put(`https://www.svavrampur.com/api/faculty/${facultyadmid}`, data);
